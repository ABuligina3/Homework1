...
public class Main {
    ...
    public static class AntiCheat {
        public static void run() {
            ...
            antiCheatList.addAll(Main.setMagazine().keySet().stream().map(Object::toString).collect(Collectors.toList()));
            antiCheatList.addAll(Main.setlungsCheck().values().stream().map(Object::toString).collect(Collectors.toList()));
